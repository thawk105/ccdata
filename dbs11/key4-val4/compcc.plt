...
set terminal pngcairo enhanced color size 24cm,24cm
set output "comp_cicada_masstree_ycsbC.png"
plot \
 "result_cicada_ycsbC_tuple500.dat" using 1:(f($2), f($3), f($4)) w errorlines title "tuple-500", \
 "result_cicada_ycsbC_tuple500k.dat" using 1:(f($2), f($3), f($4)) w errorlines title "tuple-500k", \
 "result_cicada_ycsbC_tuple5m.dat" using 1:(f($2), f($3), f($4)) w errorlines title "tuple-5m", \
 "result_cicada_ycsbC_tuple500_masstree.dat" using 1:(f($2), f($3), f($4)) w errorlines title "tuple-500-mt", \
 "result_cicada_ycsbC_tuple500k_masstree.dat" using 1:(f($2), f($3), f($4)) w errorlines title "tuple-500k-mt", \
 "result_cicada_ycsbC_tuple5m_masstree.dat" using 1:(f($2), f($3), f($4)) w errorlines title "tuple-5m-mt", \
...
set terminal pngcairo enhanced color size 24cm,24cm
set output "comp_cicada_masstree_ycsbC_ar.png"
plot \
 "result_cicada_ycsbC_tuple500.dat" using 1:5:6:7 w errorlines title "tuple-500", \
 "result_cicada_ycsbC_tuple500k.dat" using 1:5:6:7 w errorlines title "tuple-500k", \
 "result_cicada_ycsbC_tuple5m.dat" using 1:5:6:7 w errorlines title "tuple-5m", \
 "result_cicada_ycsbC_tuple500_masstree.dat" using 1:5:6:7 w errorlines title "tuple-500-mt", \
 "result_cicada_ycsbC_tuple500k_masstree.dat" using 1:5:6:7 w errorlines title "tuple-500k-mt", \
 "result_cicada_ycsbC_tuple5m_masstree.dat" using 1:5:6:7 w errorlines title "tuple-5m-mt", \
