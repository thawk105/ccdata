...
set autoscale y
set terminal pngcairo enhanced color size 20cm,20cm
set output "comp_ycsbA_tuple100m_skew0-099_tps.png"
plot \
...
set output "comp_ycsbA_tuple100m_skew0-099_ar.png"
plot \
...
set output "comp_ycsbA_tuple100m_skew0-099_cm.png"
set ylabel "cache-miss rate"
plot \
...
set autoscale y
set terminal pngcairo enhanced color size 20cm,20cm
set output "comp_ycsbA_tuple1k_skew0-099_tps.png"
plot \
...
"result_ss2pl-dlr1_ycsbA_tuple1k_skew0-099.dat" using 1:(f($2)):(f($3)):(f($4)) w errorlines pt 10 title "SS2PL", \
...
set output "comp_ycsbA_tuple1k_skew0-099_ar.png"
plot \
...
set output "comp_ycsbA_tuple1k_skew0-099_cm.png"
set ylabel "cache-miss rate"
plot \
